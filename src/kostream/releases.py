...
PATCH_2026_07_31: dict[str, Any] = {
    ...
    "sections": {
        "general": [
            ...
            "Releases changelog with per-update General / Anime / Manga / Bugfixes sections",
        ],
        "anime": [
        ...
        "bugfixes": [
            ...
            "MAL episode-title HTML scrape uses /episodes (fixes 404 fallback for some mal_ids)",
        ],
    },
}
